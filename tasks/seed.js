...
try {
	game1 = await games_functions.create(game_court1._id.toString(), '06/13/2023', '10:00 AM', 10);
...
try {
	game2 = await games_functions.create(game_court1._id.toString(), '06/13/2023', '11:00 PM', 10);
...
try {
	game3 = await games_functions.create(game_court1._id.toString(), '06/13/2023', '10:00 PM', 10);
...
let game4 = null;
try {
	game4 = await games_functions.create(game_court1._id.toString(), '06/13/2023', '10:00 AM', 10);
...
let game5 = null;
try {
	game5 = await games_functions.create(game_court2._id.toString(), '06/13/2023', '10:00 AM', 10);
...
try {
	game_w_member = await games_members_functions.create(game1._id.toString(), user1._id);
...
try {
	game_w_member2 = await games_members_functions.create(game5._id.toString(), user1._id);
	console.log('created member in game');
} catch (e) {
	console.log(e);
}
...
try {
	game_w_member3 = await games_members_functions.create(game1._id.toString(), user2._id);
	console.log('created member in game');
} catch (e) {
	console.log(e);
}
...
try {
	game_w_member4 = await games_members_functions.create(game1._id.toString(), user3._id);
	console.log('created member in game');
} catch (e) {
	console.log(e);
}
